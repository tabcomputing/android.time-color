...
public class PaperView extends AbstractPaperView {
    ...
    public PaperView(Context context) {
        ...
        //selectWidget = new Widget();
        //selectWidget.setSize(0.1f);
        //selectWidget.setLocation(Widget.BOTTOM_RIGHT);
        //selectWidget.setImageOn(context.getResources().getDrawable(R.drawable.ic_check_circle_white_48dp));
        //selectWidget.setImageOff(context.getResources().getDrawable(R.drawable.ic_check_circle_black_48dp));
    }
