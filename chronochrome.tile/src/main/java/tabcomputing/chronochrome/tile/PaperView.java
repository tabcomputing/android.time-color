...
public class PaperView extends AbstractPaperView {
    ...
    protected Widget outlineWidget = new Widget(0, 1);
    ...
    public PaperView(Context context) {
        ...
        outlineWidget.setImageOn(context.getResources().getDrawable(R.drawable.outline_on));
        outlineWidget.setImageOff(context.getResources().getDrawable(R.drawable.outline_off));
        outlineWidget.setState(settings.isOutlined());
        outlineWidget.setText("Outline");
        controls.add(outlineWidget);
    ...
    protected void toggle(Widget widget) {
        ...
        switch (widget.getID()) {
            case 0:
                ...
                settings.toast(Settings.KEY_OUTLINE, context);
                break;
            case 1:
