...
public class WallpaperBinaryStripes extends WallpaperService {
    ...
    public class ChromaTimeWallpaperEngine extends Engine implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        public ChromaTimeWallpaperEngine() {
            prefs = PreferenceManager.getDefaultSharedPreferences(WallpaperBinaryStripes.this);
...
/*
        ...
        private void drawNumbers() {
            ...
            if (true) {  //settings.isClockNumbered()) {
                paint.setColor(Color.WHITE);
        ...
        private String base(int number, int base) {
            if (settings.timeType() == ClockSettings.TIME_TRADITIONAL || settings.timeType() == ClockSettings.TIME_MILITARY) {
                return "" + number;
            }
